...
<div class="container mx-auto flex flex-col xl:flex-row">
    ...
    <Contents sections={[
        { id: 'instructor', label: 'Courses Taught', note: 'as Instructor of Record' },
        { id: 'assistant', label: 'Courses Taught', note: "as Graduate Teacher's Assistant" },
        { id: 'grading', label: 'Graderships' },
    ]} />

    <!-- Content -->
    <div class="w-full xl:w-auto xl:ml-72
        ...
        <div id="assistant" class="section">
            <h2> Courses Taught <span class="subtitle">(as Graduate Teacher's Assistant)</span> </h2>
            <Card
